...
export const Icons = {
  ...
  AlertTriangle: ({ className = 'w-5 h-5' }: IconProps) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  Users: ({ className = 'w-5 h-5' }: IconProps) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 8.048M12 4.354a4 4 0 110 8.048M12 4.354A8.001 8.001 0 0019.364 12M12 4.354a8 8 0 00-7.364 7.646m0 0a8 8 0 1015.728 0" />
    </svg>
  ),
  // Status Icons
  CircleCheck: ({ className = 'w-5 h-5' }: IconProps) => (
  ...
  Hourglass: ({ className = 'w-5 h-5' }: IconProps) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
    </svg>
  ),
